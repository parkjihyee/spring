                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1"
                        ...
                        <g id="Brand-Logo"
                          ...
                          <g id="Icon"
							...
							</span> <span class="app-brand-text demo text-body fw-bolder">MemberJoin</span>
							</a>
						</div>
						<!-- /Logo -->
						...
						<form id="formAuthentication" class="mb-3" action="memberJoin.do"
							...
							<div class="mb-3 form-password-toggle">
								...
								<div class="input-group input-group-merge">
									<input type="password" id="memperPassword" class="form-control"
										name="memperPassword"
										placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
						...
						<p class="text-center">
							<span>Already have an account?</span> <a
								href="memberLoginForm.do"> <span>Sign in instead</span>
							</a>
						</p>
						
						<p class="text-center">
							<span>GO HOME PAGE?</span> <a
								href="main.do"> <span>HOME</span>
							</a>
						</p>

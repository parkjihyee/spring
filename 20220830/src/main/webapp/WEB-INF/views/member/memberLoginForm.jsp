				...
				<div class="card">
					<div class="card-body">
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1"
							...
							<div class="mb-3 form-password-toggle">
								...
								<div class="input-group input-group-merge">
									<input type="password" id="memberPassword" class="form-control"
										name="memberPassword" placeholder="Enter Your Password"
						...
						<p class="text-center">
							<span>New on our platform?</span> <a href="memberJoinForm.do">
								<span>Create an account</span>
							</a>
						</p>

						<p class="text-center">
							<span>GO HOME PAGE?</span> <a href="main.do"> <span>HOME</span>
							</a>
						</p>
